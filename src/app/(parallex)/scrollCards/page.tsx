...
const CardBasic = ({ color, description, link, src, title }: ProjectProps) => {
  return (
    <div className="h-screen flex items-center justify-center sticky top-0">
      <div style={{ backgroundColor: color }} className="w-[1000px] h-[500px]">
        {title}
      </div>
    </div>
  );
...
const CardMainScale = ({ color, description, link, src, title }: ProjectProps) => {
  ...
  return (
    <div ref={container} className="h-screen flex items-center justify-center sticky top-0 ">
      <div style={{ backgroundColor: color }} className="w-[1000px] h-[600px] rounded-2xl ">
...
// const Card = ({i, title, description, src, url, color}: ProjectProps) => {
...
//         className="flex flex-col relative h-[500px] w-[1000px] rounded-[25px] p-12 origin-top "
//       >
//         <h2 className="text-center m-0 text-2xl">{title}</h2>
...
//           <div className="w-2/5 relative top-[10%]">
//             <p className="text-base">
//               <span className="text-2xl font-title first-letter:text-2xl first-letter:font-title">
//                 {description}
//               </span>
//             </p>
//             <span className="flex items-center gap-2">
