...
const errorMap = {
  [Error.Configuration]: (
    <p>
      There was a problem. Please contact us if this error persists. Unique error code:{' '}
  ...
  [Error.OAuthAccountNotLinked]: (
    <p>
      <p>
        Wrong Account. Please contact us if this error persists. Unique error code:{' '}
